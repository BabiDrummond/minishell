...
/*   Updated: 2026/03/09 22:28:20 by bmoreira         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// exit com valor > 9223372036854775807 ou valor < -9223372036854775808 => msg: numeric argument required, exit 255
// exit > 1 arg => msg: too many arguments, não dá exit, retorna 1
// exit fora do range 0-255 => exit com valor % 256
// exit com valor no range 0-255 => exit com valor passado transformado em numero (atol)